...
import static com.chimericdream.blocktraders.config.BlockTradersConfig.*;

public class ConfigManager {
    private static ConfigHolder<BlockTradersConfig> holder;

    public static final Consumer<BlockTradersConfig> DEFAULT = (config) -> {
    ...
    public static void registerAutoConfig() {
        ...
        holder = AutoConfig.register(BlockTradersConfig.class, JanksonConfigSerializer::new);
    ...
    public static BlockTradersConfig getConfig() {
        if (holder == null) {
            return new BlockTradersConfig();
        }
